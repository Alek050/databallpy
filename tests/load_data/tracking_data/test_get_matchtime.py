...
from databallpy.load_data.tracking_data._get_matchtime import (_get_matchtime, _to_matchtime)
...
class TestGetMatchtime(unittest.TestCase):
    ...
    def test_get_matchtime(self):
        ...
        pd.testing.assert_series_equal(expected_result, _get_matchtime(input, self.metadata))
    ...
    def test_to_matchtime(self):
        ...
        expected_res = ['08:01', '44:44', '45:00+0:04', '79:55', '90:00+4:02', '103:00', '105:00+0:12', '118:00', '120:00+0:12']
