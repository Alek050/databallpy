            ...
            periods_frames=pd.DataFrame(
                {
                    ...
                    "start_time_td": [
                        np.datetime64("2019-02-21 03:30:07.000"),
                        np.datetime64("2019-02-21 03:30:08.500"),
                        np.datetime64("NaT"),
                        np.datetime64("NaT"),
                        np.datetime64("NaT"),
                    ],
                    "end_time_td": [
                        pd.to_datetime("2019-02-21 03:30:08.000"),
                        pd.to_datetime("2019-02-21 03:30:09.500"),
                        np.datetime64("NaT"),
                        np.datetime64("NaT"),
                        np.datetime64("NaT"),
                    ],
