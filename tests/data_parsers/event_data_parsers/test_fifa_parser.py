...
ED_FIFA = pd.DataFrame(
    {
        ...
        "player_name": [
            "HOME STRIKER", "HOME STRIKER", "AWAY STRIKER", "AWAY STRIKER",
            "HOME STRIKER", "AWAY STRIKER", "HOME KEEPER",
        ],
        ...
        "original_event": [
            "kickoff", "pass", "cross", "attempt_at_goal",
            "goal", "goal", "own_goal",
        ],
        "original_event_type": [
            "start_restart", "pass_like", "pass_like", "shot",
            "shot", "shot", "shot",
        ],
    }
)
...
class TestFifaParser(unittest.TestCase):
    ...
    def test_make_pass_instance(self):
        ...
        event = {
            "team_id": 100, "from_player_id": 1002, "event_id": 102,
            "event_type": "pass_like", "category": "in_possession",
            "event": "pass", "half_time": 1, "match_time_in_ms": 5000,
            "side": None, "x": 0.25, "y": 0.5,
            "outcome": "possession_complete", "body_type": "right_foot",
            "origin": None, "line_break_direction": None,
            "x_location_start": 0.25, "y_location_start": 0.5,
            "x_location_end": 0.75, "y_location_end": 0.5,
        }
        pass_event = _make_pass_instance(
            event, home_team_id=100, away_team_id=200,
            players=self._all_players, id=2, period_id=1,
            flip_first_half=False, flip_second_half=True,
            kickoff_time=_KO_UTC,
        )
        expected = PassEvent(
            event_id=2, period_id=1, minutes=0, seconds=5,
            datetime=_KO_UTC + pd.to_timedelta(5, unit="s"),
            start_x=-26.25, start_y=0.0, pitch_size=[105.0, 68.0],
            team_id=100, team_side="home", player_id=1002, jersey=9,
            related_event_id=MISSING_INT, set_piece="no_set_piece",
            possession_type="open_play", body_part="right_foot",
            outcome=True, outcome_str="successful",
            end_x=26.25, end_y=0.0, pass_type="unspecified", _xt=-1.0,
        )
    ...
    def test_make_cross_instance(self):
        ...
        event = {
            "team_id": 200, "from_player_id": 2002, "event_id": 103,
            "event_type": "pass_like", "category": "in_possession",
            "event": "cross", "half_time": 1, "match_time_in_ms": 30000,
            "side": None, "x": 0.75, "y": 0.25,
            "outcome": "possession_complete", "body_type": "left_foot",
            "origin": None, "line_break_direction": None,
            "x_location_start": 0.75, "y_location_start": 0.25,
            "x_location_end": 0.5, "y_location_end": 0.75,
        }
        pass_event = _make_pass_instance(
            event, home_team_id=100, away_team_id=200,
            players=self._all_players, id=3, period_id=1,
            flip_first_half=False, flip_second_half=True,
            kickoff_time=_KO_UTC,
        )
        expected = PassEvent(
            event_id=3, period_id=1, minutes=0, seconds=30,
            datetime=_KO_UTC + pd.to_timedelta(30, unit="s"),
            start_x=26.25, start_y=-17.0, pitch_size=[105.0, 68.0],
            team_id=200, team_side="away", player_id=2002, jersey=9,
            related_event_id=MISSING_INT, set_piece="no_set_piece",
            possession_type="open_play", body_part="left_foot",
            outcome=True, outcome_str="successful",
            end_x=0.0, end_y=17.0, pass_type="cross", _xt=-1.0,
        )
        assert pass_event == expected
    ...
    def test_make_shot_event_instance_on_target(self):
        ...
        event = {
            "team_id": 200, "from_player_id": 2002, "event_id": 104,
            "event_type": "shot", "category": "in_possession",
            "event": "attempt_at_goal", "half_time": 1, "match_time_in_ms": 60000,
            "side": None, "x": 0.75, "y": 0.5, "outcome": "on_target",
            "body_type": "head", "origin": None, "line_break_direction": None,
            "x_location_start": None, "y_location_start": None,
            "x_location_end": None, "y_location_end": None,
        }
        shot_event = _make_shot_event_instance(
            event, home_team_id=100, away_team_id=200,
            players=self._all_players, id=4, period_id=1,
            flip_first_half=False, flip_second_half=True,
            kickoff_time=_KO_UTC,
        )
        expected = ShotEvent(
            event_id=4, period_id=1, minutes=1, seconds=0,
            datetime=_KO_UTC + pd.to_timedelta(60, unit="s"),
            start_x=26.25, start_y=0.0, pitch_size=[105.0, 68.0],
            team_id=200, team_side="away", player_id=2002, jersey=9,
            related_event_id=MISSING_INT, set_piece="no_set_piece",
            possession_type="open_play", body_part="head",
            outcome=False, outcome_str="miss_on_target", _xt=-1.0,
        )
    ...
    def test_make_shot_event_instance_goal(self):
        ...
        event = {
            "team_id": 100, "from_player_id": 1002, "event_id": 105,
            "event_type": "shot", "category": "in_possession",
            "event": "goal", "half_time": 2, "match_time_in_ms": 3_700_000,
            "side": None, "x": 0.75, "y": 0.5, "outcome": None,
            "body_type": None, "origin": None, "line_break_direction": None,
            "x_location_start": None, "y_location_start": None,
            "x_location_end": None, "y_location_end": None,
        }
        shot_event = _make_shot_event_instance(
            event, home_team_id=100, away_team_id=200,
            players=self._all_players, id=5, period_id=2,
            flip_first_half=False, flip_second_half=True,
            kickoff_time=_KO_UTC,
        )
        expected = ShotEvent(
            event_id=5, period_id=2, minutes=61, seconds=40,
            datetime=_KO_UTC + pd.to_timedelta(3700, unit="s"),
            start_x=-26.25, start_y=0.0, pitch_size=[105.0, 68.0],
            team_id=100, team_side="home", player_id=1002, jersey=9,
            related_event_id=MISSING_INT, set_piece="no_set_piece",
            possession_type="open_play", body_part="unspecified",
            outcome=True, outcome_str="goal", _xt=-1.0,
        )
        assert shot_event == expected
    ...
    def test_make_shot_event_instance_own_goal(self):
        ...
        event = {
            "team_id": 100, "from_player_id": 1001, "event_id": 107,
            "event_type": "shot", "category": "in_possession",
            "event": "own_goal", "half_time": 2, "match_time_in_ms": 5_400_000,
            "side": None, "x": 0.25, "y": 0.75, "outcome": None,
            "body_type": None, "origin": None, "line_break_direction": None,
            "x_location_start": None, "y_location_start": None,
            "x_location_end": None, "y_location_end": None,
        }
        shot_event = _make_shot_event_instance(
            event, home_team_id=100, away_team_id=200,
            players=self._all_players, id=7, period_id=2,
            flip_first_half=False, flip_second_half=True,
            kickoff_time=_KO_UTC,
        )
        expected = ShotEvent(
            event_id=7, period_id=2, minutes=90, seconds=0,
            datetime=_KO_UTC + pd.to_timedelta(5400, unit="s"),
            start_x=26.25, start_y=-17.0, pitch_size=[105.0, 68.0],
            team_id=100, team_side="home", player_id=1001, jersey=1,
            related_event_id=MISSING_INT, set_piece="no_set_piece",
            possession_type="open_play", body_part="unspecified",
            outcome=False, outcome_str="own_goal", _xt=-1.0,
        )
        assert shot_event == expected
    ...
    def test_determine_period_flips_home_side_l(self):
        ...
        events = [
            {"half_time": 1, "event": "kickoff", "from_player_id": 1002,
             "team_id": 100, "side": "l"},
        ]
    ...
    def test_determine_period_flips_away_kickoff(self):
        ...
        events = [
            {"half_time": 1, "event": "kickoff", "from_player_id": 2002,
             "team_id": 200, "side": "r"},
        ]
        flip_first, flip_second = _determine_period_flips(events, 100, 200)
        self.assertFalse(flip_first)
    ...
    def test_determine_period_flips_no_kickoff(self):
        ...
        events = [
            {"half_time": 1, "event": "pass", "from_player_id": 1002,
             "team_id": 100, "side": None},
        ]
        flip_first, flip_second = _determine_period_flips(events, 100, 200)
        self.assertFalse(flip_first)
        self.assertFalse(flip_second)
