...
class TestFilters(unittest.TestCase):
    ...
    def test_moving_average_filter(self):
        ...
        output_1 = filter_data(self.input, ["col_1", "col_2"])
    ...
    def test_single_column_filter(self):
        ...
        output_2 = filter_data(self.input, ["col_1"])
    ...
    def test_filters_wrong_input(self):
        ...
        self.assertEqual(
            str(cm.exception), "kind should be one of moving_average, not magic_filter"
        )

        with self.assertRaises(TypeError) as cm:
            filter_data(self.input, ["col_1", "col_2"], "moving_average", "5")
        self.assertEqual(
