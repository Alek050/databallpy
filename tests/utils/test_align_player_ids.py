...
from databallpy.utils.align_player_ids import align_player_ids_name_similarity, get_matching_full_name
...
class TestAlginPlayerIds(unittest.TestCase):
    def test_align_player_ids(self):
        ...
        aligned_metadata = align_player_ids_name_similarity(unaligned_metadata, MD_INMOTIO)
