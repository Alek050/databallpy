...
def _normalize_playing_direction(td:pd.DataFrame, periods:pd.DataFrame) -> pd.DataFrame:
    ...
    Returns:
        pd.DataFrame: tracking data of the match, normalized in x and y direction in such 
        a way that the home team is represented of playing from left to right for the 
        full match.
    """
